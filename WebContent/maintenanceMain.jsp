...
<head>
	...
	function selectMaintenance() {
		...
		"						<th align=\"center\" valign=\"middle\" width=\"30%\">保养项目名称</th>" + 
		...
		$.ajax({
	        ...
	        success:function(data,textStatus){
	        	...
	        	for (var i = 0; i < data.data.length; i++) {
					...
					%>
					"			<a href=\"updateMaintenance.jsp?id="+data.data[i].id+"\">编辑</a><span class=\"gray\">&nbsp;|&nbsp;</span>" + 
					<%}%>
					<%
...
<body>
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
		<tr>
			<td width="99%" align="left" valign="top">您的位置：保养项目信息</td>
		</tr>
		<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
					<tr>
						...
						<td width="10%" align="center" valign="middle" style="text-align:right; width:150px;">
							...
							%>
							<a href="addMaintenance.jsp" class="add">新增保养项目</a>
							<%} %>
						</td>
					</tr>
				</table>
