...
<head>
	...
	"						<th align=\"center\" valign=\"middle\" width=\"50%\">订保项目名称</th>" + 
...
<body>
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
		<tr>
			<td width="99%" align="left" valign="top">您的位置：设备保养项目绑定管理</td>
		</tr>
		<tr>
			<td align="left" valign="top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
					<tr>
						...
						%>
							<a href="addDandM.jsp" class="add">保养项目绑定</a>
						<%} %>
						</td>
					</tr>
				</table>
