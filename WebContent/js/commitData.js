window.onload = function() {
	...
	function recoverForm() {
		 ...
		 * lzx begin
		 */
		var dateTimeCreate = document.getElementById("dateTimeCreate");
		if(dateTimeCreate) {
			dateTimeCreate.value=year+"-"+month+"-"+day+" "+hour+":"+minutes+":"+seconds;
		}
		var dateDom = document.getElementById("dateTimeNo");
		if(dateDom) {
			dateDom.value=year+"-"+month+"-"+day;
		}
		
		var dateTimeEn = document.getElementById("dateTimeEnable");
		if(dateTimeEn) {
			dateTimeEn.value=year+"-"+month+"-"+day+" "+hour+":"+minutes+":"+seconds;
		}
		
		var dateTimest = document.getElementById("dateTimeStop");
		if(dateTimest) {
			dateTimest.value=year+"-"+month+"-"+day+" "+hour+":"+minutes+":"+seconds;
		}
		
		
		var dateTimemo = document.getElementById("dateTimeModify");
		if(dateTimemo) {
			dateTimemo.value=year+"-"+month+"-"+day+" "+hour+":"+minutes+":"+seconds;
		}
		
		var dateTimedc = document.getElementById("dateTimedc");
		if(dateTimedc) {
			dateTimedc.value=year+"-"+month+"-"+day;
		}
