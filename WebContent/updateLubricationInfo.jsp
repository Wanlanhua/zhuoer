...
<script type="text/javascript">
	$(function() {
		$.ajax({
	       ...
	       type:"GET",  
	       url:"Z_LubricationInfoSelectOnly",
	       data:{
	    	   id:"<%=id%>"
	       },
	...
	function updataMaintenance() {
		...
		$.ajax({
	       ...
	       success:function(data,textStatus){ 
	    	   alert(data.message);
	    	   window.location.href="lubricationMain.jsp";
	       }  
       });
	}
</script>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：润滑项目信息&nbsp;&nbsp;>&nbsp;&nbsp;修改润滑项目</td>
  </tr>
  <tr>
    <td align="left" valign="top" >
   <h2 class="add blue">修改润滑项目</h2>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class=" bggray">润滑项目名称：</td>
