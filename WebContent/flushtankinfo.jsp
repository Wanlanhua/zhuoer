...
<%
	...
	if(session.getAttribute("pageSizeFTI") != null )
		pageSize = Integer.parseInt(session.getAttribute("pageSizeFTI").toString());
	if(session.getAttribute("thisPageFTI")!=null)
		thisPage = Integer.parseInt(session.getAttribute("thisPageFTI").toString());
	if(pageSize%15==0)
...
<script>
	var addActionTarget = "<%=request.getContextPath() %>/careDevice/InsertFTI";
	var updateActionTarget = "<%=request.getContextPath() %>/careDevice/UpdateFTI";
	var stateActionTarget = "<%=request.getContextPath() %>/careDevice/StateFTI";
	var deleteActionTarget = "<%=request.getContextPath() %>/careDevice/DelFTI";
</script>
</head>
<body>
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：集中供气气体罐冲信息</td>
  </tr>
  <tr>
  <%
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="85%" align="left" valign="middle">
	         <form method="post" action="<%=request.getContextPath() %>/careDevice/GetFTI?page=1">
	         <span>设备单位：</span>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr  class="bggray">
        ...
        <th align="center" valign="middle" >气体罐</th>
        <th align="center" valign="middle" >充装前表码</th>
        <th align="center" valign="middle">充装结束表码</th>
        <th align="center" valign="middle">对应重量</th>
      ...
      <%
      		List<FlushTankInfo> list = (List)request.getSession().getAttribute("listFTI");
      		if(list != null) {
      ...
      %>
			      ...
			      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
			        ...
			        <th align="center" valign="middle" ><%=list.get(i).getGasTank() %></th>
			        <th align="center" valign="middle" ><%=list.get(i).getCode() %></th>
			        <th align="center" valign="middle" ><%=list.get(i).getFinishCode() %></th>
			        <th align="center" valign="middle" ><%=list.get(i).getWeight() %></th>
			        ...
			        %>
				        <td align="center" valign="middle" class="borderbottom">
				        	...
				        	<%
					         ...
					         %>
				        	<a href="<%=request.getContextPath() %>/careDevice/DelFTI?id=<%=list.get(i).getId() %>" style="display:<%=classNone%>;" target="mainFrame" onFocus="this.blur()" onclick="return deleteData()" class="deleteData">删除</a>
				        	<!--
				            	作者：923501316@qq.com
				            	时间：2018-04-18
				            	描述：如果该记录被审核，则允许再次审核
				        	...
				        	<%
					         ...
					         %>
				        	<span class="gray" style="display:<%=classNone%>;">&nbsp;|&nbsp;</span>
				        	<a href="javascript:void(0);" target="mainFrame" style="display:<%=classNone%>;" onFocus="this.blur()" class="stateData">审核</a>
				        </td>
		        <%
			        	}
		        	}
    ...
    %>
		  <tr>
		    <td align="left" valign="top" class="fenye">
	    		...
	    		<a href="<%=request.getContextPath() %>/careDevice/GetFTI?page=1" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;
		    	<%
		    		int beforePage = thisPage - 1;
		    		if(thisPage>1) {
		    		
		    	%>
		    		<a href="<%=request.getContextPath() %>/careDevice/GetFTI?page=<%=beforePage %>" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
		    	<% 
		    		}
		    	%>
		    	<%
		    	...
		    	%>
		    		<a href="<%=request.getContextPath() %>/careDevice/GetFTI?page=<%=afterPage %>" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
		    	<%
		    		}
		    	%>
		    	...
		    	%>
		    		<a href="<%=request.getContextPath() %>/careDevice/GetFTI?page=<%=pageSize %>" target="mainFrame" onFocus="this.blur()">尾页</a></td>
		    	<%
		    		}
		    	%>
		  </tr>
		    	...
		    	<td align="left" valign="top">
			    	<form method="post" action="">
				    	<table width="90%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
							...
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
								<td align="right" valign="middle" class=" bggray">气体罐：</td>
								<td align="left" valign="middle">
									<input type="text" name="gasTank" value="" stateDisabled >
								</td>
							</tr>
							
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
								<td align="right" valign="middle" class=" bggray">充装前表码：</td>
								<td align="left" valign="middle">
									<input type="text" name="code" value="" stateDisabled >
								</td>
							</tr>
							
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
								<td align="right" valign="middle" class=" bggray">充装结束表码：</td>
								<td align="left" valign="middle">
									<input type="text" name="finishCode" value="" stateDisabled >
								</td>
							</tr>
							
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
								<td align="right" valign="middle" class=" bggray">对应重量：</td>
								<td align="left" valign="middle">
									<input type="text" name="weight" value="" stateDisabled >
								</td>
							</tr>
