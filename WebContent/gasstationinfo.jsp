...
<%
	...
	if(session.getAttribute("pageSizeGSI") != null )
		pageSize = Integer.parseInt(session.getAttribute("pageSizeGSI").toString());
	if(session.getAttribute("thisPageGSI")!=null)
		thisPage = Integer.parseInt(session.getAttribute("thisPageGSI").toString());
	if(pageSize%15==0)
...
<script>
	var addActionTarget = "<%=request.getContextPath() %>/careDevice/InsertGSI";
	var updateActionTarget = "<%=request.getContextPath() %>/careDevice/UpdateGSI";
	var stateActionTarget = "<%=request.getContextPath() %>/careDevice/StateGSI";
	var deleteActionTarget = "<%=request.getContextPath() %>/careDevice/DelGSI";
</script>
</head>
<body>
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：供气站看护信息</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		...
  		%>
   		 <td width="88%" align="left" valign="middle">
	         <form method="post" action="<%=request.getContextPath() %>/careDevice/GetGSI?page=1">
	         <span>设备单位：</span>
         ...
         %>
  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:170px;display:<%=classNone%>"><a href="javascript:void(0);" target="mainFrame" onFocus="this.blur()" class="add" id="addDom">供气站看护信息</a></td>
  		</tr>
	</table>
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr  class="bggray">
        ...
        <th align="center" valign="middle">氧气压力</th>
        <th align="center" valign="middle">丙烷压力</th>
        <th align="center" valign="middle">天然气压力</th>
        <th align="center" valign="middle">阀门关闭情况</th>
        <th align="center" valign="middle">站房温度</th>
        <th align="center" valign="middle">供气管道</th>
      ...
      <%
      		List<GasStationInfo> list = (List)request.getSession().getAttribute("listGSI");
      		if(list != null) {
      ...
      %>
			      ...
			      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
			        ...
			        <th align="center" valign="middle" ><%=list.get(i).getOxygen() %></th>
			        <th align="center" valign="middle" ><%=list.get(i).getAcetylene() %></th>
			        <th align="center" valign="middle" ><%=list.get(i).getArgon() %></th>
			        <th align="center" valign="middle" ><%=list.get(i).getValve() %></th>
			        <th align="center" valign="middle" ><%=list.get(i).getStation() %></th>
			        <th align="center" valign="middle" ><%=list.get(i).getConduit() %></th>
			        ...
			        %>
				        <td align="center" valign="middle" class="borderbottom">
				        	...
				        	<%
					         ...
					         %>
				        	<a href="<%=request.getContextPath() %>/careDevice/DelGSI?id=<%=list.get(i).getId() %>" style="display:<%=classNone%>;" target="mainFrame" onFocus="this.blur()" onclick="return deleteData()" class="deleteData">删除</a>
				        	<!--
				            	作者：923501316@qq.com
				            	时间：2018-04-18
				            	描述：如果该记录被审核，则允许再次审核
    ...
    %>
		  <tr>
		    <td align="left" valign="top" class="fenye">
	    		...
	    		<a href="<%=request.getContextPath() %>/careDevice/GetGSI?page=1" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;
		    	<%
		    		int beforePage = thisPage - 1;
		    		if(thisPage>1) {
		    		
		    	%>
		    		<a href="<%=request.getContextPath() %>/careDevice/GetGSI?page=<%=beforePage %>" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
		    	<% 
		    		}
		    	%>
		    	<%
		    	...
		    	%>
		    		<a href="<%=request.getContextPath() %>/careDevice/GetGSI?page=<%=afterPage %>" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
		    	<%
		    		}
		    	%>
		    	...
		    	%>
		    		<a href="<%=request.getContextPath() %>/careDevice/GetGSI?page=<%=pageSize %>" target="mainFrame" onFocus="this.blur()">尾页</a></td>
		    	<%
		    		}
		    	%>
		  </tr>
...
<div id="dataBox">
	...
	<div style="text-align: center;width:45%;">
		<div class="data_head">
			<h2><span id="dataBoxTitle"></span>供气站看护信息</h2>
			    	...
			    	<form method="post" action="">
				    	<table width="90%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
							...
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
								...
								<td align="left" valign="middle">
									<input type="text" name="maintenanceDate" id="dateTime" value="" stateDisabled >
								</td>
							</tr>
							
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
								<td align="right" valign="middle" class=" bggray">氧气压力：</td>
								<td align="left" valign="middle">
									<input type="text" name="oxygen" value="" stateDisabled >
								</td>
							</tr>
							
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
								<td align="right" valign="middle" class=" bggray">乙炔压力：</td>
								<td align="left" valign="middle">
									<input type="text" name="acetylene" value="" stateDisabled >
								</td>
							</tr>
							
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
								<td align="right" valign="middle" class=" bggray">氩气压力：</td>
								<td align="left" valign="middle">
									<input type="text" name="argon" value="" stateDisabled >
								</td>
							</tr>
							
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
								<td align="right" valign="middle" class=" bggray">阀门关闭情况：</td>
								<td align="left" valign="middle">
									<input type="text" name="valve" value="" stateDisabled >
								</td>
							</tr>
							...
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
								<td align="right" valign="middle" class=" bggray">供气管道：</td>
								<td align="left" valign="middle">
									<input type="text" name="conduit" value="" stateDisabled >
								</td>
							</tr>
