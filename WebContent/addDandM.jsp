...
function autoInserMaintOption(){ 
    ...
    $.ajax({
       ...
       contentType: "application/x-www-form-urlencoded; charset=utf-8", 
       type:"GET",  
       url:"MaintenanceContentSerchServlet",
       data:{
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：设备保养项目绑定管理&nbsp;&nbsp;>&nbsp;&nbsp;绑定保养项目</td>
  </tr>
  <tr>
    <td align="left" valign="top" >
   <h2 class="add blue">新增绑定保养项目</h2>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class=" bggray">保养搜索：</td>
        <td align="left" valign="middle" >
       ...
       <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class=" bggray">保养项目：</td>
        <td align="left" valign="middle" class="dataNotNull">
