...
<script type="text/javascript">
	$(function(){
		$.ajax({
	       ...
	       type:"GET",  
	       url:"Z_DevicePartInfoSelectOnly", 
	       data:{
	    	   id:"<%=id%>"
	       },
	...
	function updateDevicePart() {
		...
		$.ajax({
	       ...
	       success:function(data,textStatus){ 
	    	   alert(data.message);
	    	   window.location.href="devicePartMain.jsp";
	       }  
       }); 
	}
</script>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：设备部位信息&nbsp;&nbsp;>&nbsp;&nbsp;修改设备部位</td>
  </tr>
  <tr>
    <td align="left" valign="top" >
   <h2 class="add blue">修改设备部位</h2>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
