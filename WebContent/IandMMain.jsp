...
<head>
	...
	/* 查询监听事件 */
	function SearchDandM() {
		var tableHead = "<tr class=\"bggray\">\r\n" + 
	"						<th align=\"center\" valign=\"middle\">设备编号</th>" + 
	"						<th align=\"center\" valign=\"middle\" width=\"50%\">润滑项目名称</th>" + 
...
<body>
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
		<tr>
			<td width="99%" align="left" valign="top">您的位置：设备润滑项目绑定管理</td>
		</tr>
		<tr>
					...
					<tr>
						<td width="90%" align="left" valign="middle">
							<form method="post" action="" >
								...
								%>
								<input type="button" value="查询" class="text-but" onclick="SearchDandM()">
								<%} %>
							</form>
						</td>
						...
						%>
							<a href="addIandM.jsp" class="add">设备润滑绑定</a>
						<%} %>
						</td>
					</tr>
				</table>
