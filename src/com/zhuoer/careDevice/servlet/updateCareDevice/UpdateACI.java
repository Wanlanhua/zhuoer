...
/**
 * Servlet implementation class UpdateACI
 */
@WebServlet("/careDevice/UpdateACI")
public class UpdateACI extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ucdi.updateAirCompressorInfo(aci, request.getSession().getAttribute("name").toString());
