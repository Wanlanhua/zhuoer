...
/**
 * Servlet implementation class UpdateECRHI
 */
@WebServlet("/careDevice/UpdateERHI")
public class UpdateERHI extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		erhi.setId(Integer.parseInt(id));
		...
		ucdi.updateElectricityRunHInfo(erhi, request.getSession().getAttribute("name").toString());
