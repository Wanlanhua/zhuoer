...
/**
 * Servlet implementation class InsertECRLI
 */
@WebServlet("/careDevice/InsertERLI")
public class InsertERLI extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		icdi.insertElectricityRunLInfo(erli,request.getSession().getAttribute("name").toString());
		
		Object qnameObject = request.getSession().getAttribute("queryERLI");
		String qname = "";
		if(qnameObject!=null) {
