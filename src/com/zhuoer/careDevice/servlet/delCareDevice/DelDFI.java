...
/**
 * Servlet implementation class DelDFI
 */
@WebServlet("/careDevice/DelDFI")
public class DelDFI extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dcdi.deleteDailyFlowInfo(id, request.getSession().getAttribute("name").toString());
