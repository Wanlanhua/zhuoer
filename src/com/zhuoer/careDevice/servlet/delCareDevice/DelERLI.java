...
/**
 * Servlet implementation class DelECRLI
 */
@WebServlet("/careDevice/DelERLI")
public class DelERLI extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dcdi.deleteElectricityRunLInfo(id, request.getSession().getAttribute("name").toString());
