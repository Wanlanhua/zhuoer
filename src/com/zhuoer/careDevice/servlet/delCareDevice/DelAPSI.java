...
/**
 * Servlet implementation class DelAPSI
 */
@WebServlet("/careDevice/DelAPSI")
public class DelAPSI extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dcdi.deleteAirPressureStationInfo(id, request.getSession().getAttribute("name").toString());
