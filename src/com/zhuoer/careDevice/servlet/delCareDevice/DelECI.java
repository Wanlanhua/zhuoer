...
/**
 * Servlet implementation class DelECI
 */
@WebServlet("/careDevice/DelECI")
public class DelECI extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dcdi.deleteElectricityInfo(id, request.getSession().getAttribute("name").toString());
