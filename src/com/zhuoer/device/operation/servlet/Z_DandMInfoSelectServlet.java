 ...
 */
@WebServlet("/Z_DandMInfoSelectServlet")
public class Z_DandMInfoSelectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Z_DandMInfoSelectServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql ="";
		String sql2 = "";
		sql = "SELECT dandminfo.* "
				+ "FROM dandminfo,deviceinfo "
				+ "where deviceinfo.area = ? and deviceinfo.no = dandminfo.deviceNo and "
				+ "DandMInfo.deviceNo like ?"
				+ "limit ?,15";
		sql2="SELECT count(*) "
				+ "FROM dandminfo,deviceinfo "
				+ "where deviceinfo.area = ? and deviceinfo.no = dandminfo.deviceNo and "
