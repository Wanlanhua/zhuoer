 ...
 */
@WebServlet("/Z_DandPInfoSelectServlet")
public class Z_DandPInfoSelectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Z_DandPInfoSelectServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<DandPInfo> deviceName =null;
		...
		String sql ="";
		String sql2 = "";
		sql = "SELECT dandPinfo.* "
				+ "FROM DandPInfo,deviceinfo "
				+ "where deviceinfo.area = ? and deviceinfo.no = DandPInfo.deviceNo and "
				+ "DandPInfo.deviceNo like ?"
				+ "limit ?,15";
		sql2="SELECT count(*) "
				+ "FROM DandPInfo,deviceinfo "
				+ "where deviceinfo.area = ? and deviceinfo.no = DandPInfo.deviceNo and "
		...
		PageBean<DandPInfo> pbDevice = new PageBean<>(page, a);
		deviceName =Z_DandPInfoCrudDao.selectDandPInfo(sql, p);
