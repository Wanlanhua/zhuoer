 ...
 */
@WebServlet("/Z_LubricationInfoSelectOnly")
public class Z_LubricationInfoSelectOnly extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Z_LubricationInfoSelectOnly() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		sql = "select * from lubricationInfo where id = ?";
		p.add(id);
