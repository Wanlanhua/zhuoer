 ...
 */
@WebServlet("/Z_LubricationInfoUpdate")
public class Z_LubricationInfoUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Z_LubricationInfoUpdate() {
        super();
...
//			return;
//		}
		String sql="update lubricationInfo set content=?,stamp=? ,mark=? where id=?";
