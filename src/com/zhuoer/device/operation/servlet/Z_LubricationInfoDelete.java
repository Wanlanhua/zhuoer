 ...
 */
@WebServlet("/Z_LubricationInfoDelete")
public class Z_LubricationInfoDelete extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Z_LubricationInfoDelete() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql="delete from lubricationInfo where id=?";
		List<Object> p = new ArrayList<>();
		p.add(id);
		boolean flag = Z_MaintenanceInfoCrudDao.deleteMaintenanceInfo(sql, p);
