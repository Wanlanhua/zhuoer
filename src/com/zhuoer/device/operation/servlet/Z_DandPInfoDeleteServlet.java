 ...
 */
@WebServlet("/Z_DandPInfoDeleteServlet")
public class Z_DandPInfoDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Z_DandPInfoDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		p.add(id);
		String sql = "delete from DandPInfo where id=?";
		boolean flag = Z_DandPInfoCrudDao.deleteDandPInfo(sql,p);
