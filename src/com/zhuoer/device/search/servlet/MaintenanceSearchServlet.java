 ...
 */
@WebServlet("/MaintenanceSearchServlet")
public class MaintenanceSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MaintenanceSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql = "select content from MaintenanceInfo where customerNo = ? and content like ? limit 0,15";
