...
/**
 * Servlet implementation class UpdateCustomerContact
 */
@WebServlet("/UpdateCustomerContact")
public class UpdateCustomerContact extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CustomerContactInfoDao.updateCustomerContact(cci, request.getSession().getAttribute("name").toString());
		String qname = request.getSession().getAttribute("queryCCI").toString();
		response.sendRedirect(request.getContextPath()+"/GetCustomerContact?qname="+qname);
	}
