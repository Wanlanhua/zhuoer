...
/**
 * Servlet implementation class GetCareDevice
 */
@WebServlet("/GetCareDevice")
public class GetCareDevice extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetCareDevice() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String no = request.getParameter("shebei");
		String sql = "select no,name from deviceinfo where no = '"+no+"'";
